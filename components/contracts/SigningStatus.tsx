...
import { isSetuSigningEnabled } from '@/utils/featureFlags';
              ...
              return (
                <div key={step.id} className="relative flex gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-[#667085] mt-1">{step.description}</p>
