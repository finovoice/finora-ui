...
import { importLeadAPI, bulkCreateLeadsAPI, getAllUsers } from "@/services/clients"; // Import bulkCreateLeadsAPI
import { LeadType, RMUser } from "@/constants/types";
  ...
  useEffect(() => {
    const fetchRms = async () => {
      try {
        ...
        setRms(data);
        if (data.length > 0) setAssignedRM(data[0].email);
          ...
          <TabsContent value="manual" className="p-6 space-y-5">
            <div className="grid grid-cols-2 gap-4 ">
              ...
              <div>
                ...
                <Input
                  id="email"
                  placeholder="olivia.rhye@email.com"
                  className="h-10 border-[#d0d5dd] focus-visible:ring-0 focus-visible:ring-offset-0"
                  value={email}
            ...
            <div className="space-y-1">
              ...
              <Select defaultValue={assignedRM} onValueChange={setAssignedRM}>
              ...
              <>
                <div className="rounded-lg border border-[#e4e7ec] bg-[#fcfcfd] p-5 space-y-2">
                  ...
                  <ol className="list-decimal list-inside text-sm text-[#667085] space-y-1">
                    <li>
                      <span className="font-semibold">First name*</span> - first
                      name of the client
                    </li>
                    <li>
                      <span className="font-semibold">Last name*</span> - last
                      name of the client
                    </li>
                    <li>
                      <span className="font-semibold">Email</span> - valid email
                      fo the client (optional)
                    </li>
                    <li>
                      <span className="font-semibold">Phone number*</span> - add
                      client's valid whatsapp number
                    </li>
                    <li>
