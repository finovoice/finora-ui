    ...
    <div className="flex items-center justify-between border-b border-[#e4e7ec] px-5 py-4">
      <div className="min-w-0">
        <div className="flex items-center gap-2">
          ...
          <button onClick={onEdit} className="rounded p-1 text-[#667085] hover:bg-[#f2f4f7]" aria-label="Edit name">
      ...
      <div className="ml-4">
        ...
        <Select open={isStageSelectOpen} onOpenChange={setIsStageSelectOpen} value={stage} onValueChange={(v) => { setStage(v as any) }}>
