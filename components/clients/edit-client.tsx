...
import { ClientType, EditableClient, RMUser } from "@/constants/types";
...
export default function EditClient({
  ...
  useEffect(() => {
    if (open && client) {
      ...
      setAssignedRM(client.assigned_rm?.email);
      console.log(client.assigned_rm?.email); // Assuming assigned_rm has an email
      setRisk(client.risk);
    }
  }, [open, client]);
